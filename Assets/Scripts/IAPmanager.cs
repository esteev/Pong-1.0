...
public class IAPmanager : MonoBehaviour, IStoreListener
{
	...
	public static string PRODUCT_MCD = "mcd";   
	public static string PRODUCT_DRUNK= "drunk";   
	...
	public void InitializePurchasing() 
	{
		...
		builder.AddProduct(PRODUCT_MCD, ProductType.NonConsumable);
		builder.AddProduct(PRODUCT_DRUNK, ProductType.NonConsumable);
	...
	public void BuyMCD(){
		BuyProductID (PRODUCT_MCD);
	}
	public void BuyDrunk(){
		BuyProductID (PRODUCT_DRUNK);
	}
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
	{
		...
		else if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_MCD, StringComparison.Ordinal))
		{	
		//	youdidthistoher.Instance.MCDActive = 1;
			Debug.Log ("MCD is purchased");
			GameObject.Find ("MainMenu").GetComponent<MainMenu> ().buySpecialMCD ();
		}
		else if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_DRUNK, StringComparison.Ordinal))
		{	
		//	youdidthistoher.Instance.DrunkActive = 1;
			Debug.Log ("Drunk is purchased");
			GameObject.Find ("MainMenu").GetComponent<MainMenu> ().buySpecialDrunk ();
		}
		else 
		{
