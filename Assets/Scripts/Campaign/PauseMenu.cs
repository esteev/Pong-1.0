			...
			if (isSelected [i] == 1) {
				...
				case 0:	
					PowerUp.bigBallPurchased = true;
						GameManager.bigBallPurchased = true;
					break;
				case 1:
					PowerUp.flareBallPurchased = true;
						GameManager.flareBallPurchased = true;
					break;
				case 2:
					PowerUp.gunPadPurchased = true;
						GameManager.gunPadPurchased = true;
					break;
				case 3:
					PowerUp.padLongPurchased = true;
						GameManager.padLongPurchased = true;
					break;
				case 4:
					PowerUp.magnetPadPurchased = true;
						GameManager.magnetPadPurchased = true;
					break;
				case 5:
					PowerUp.VIPBallPurchased = true;
						GameManager.VIPBallPurchased = true;
					break;
				case 6:
					PowerUp.multiBallPurchased = true;			
						GameManager.multiBallPurchased = true;
					break;
				}
			}
		}
